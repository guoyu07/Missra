...
if(empty($dopost))
{
    ...
    include(MIMEMBER."/templets/article_add.htm");
    exit();
}
/*------------------------------
...
'$color','$writer','$source','$litpic','$pubdate','$senddate','$mid','$description','$keywords','$mtypesid'); ";
    ...
    &nbsp;&nbsp;
    <a href='article_edit.php?channelid=$channelid&aid=$arcID'>更改文章</a>
    &nbsp;&nbsp;
    <a href='content_list.php?channelid={$channelid}'>已发布文章管理</a>";
    $wintitle = "成功发布文章！";
