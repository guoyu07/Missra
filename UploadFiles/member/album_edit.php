...
if(empty($dopost))
{
    ...
    include(MIMEMBER."/templets/album_edit.htm");
    exit();
}
/*------------------------------
function _Save(){  }
...
else if($dopost=='save')
{
    ...
    $imgurls = "{missra:pagestyle maxwidth='$maxwidth' pagepicnum='$pagepicnum'
...
&nbsp;&nbsp;
<a href='$artUrl' target='_blank'>查看图集</a>
&nbsp;&nbsp;
<a href='content_list.php?channelid=$channelid'>管理图集</a> ";
