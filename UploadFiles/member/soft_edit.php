...
if(empty($dopost))
{
    ...
    $tags = GetTags($aid);
    include(MIMEMBER."/templets/soft_edit.htm");
    exit();
}
/*------------------------------
...
else if($dopost=='save')
{
    ...
    //返回成功信息
    $msg = "　　请选择你的后续操作：
        <a href='soft_add.php?cid=$typeid'>发布新软件</a>
        &nbsp;&nbsp;
        <a href='soft_edit.php?channelid=$channelid&aid=".$aid."'>返回更改</a>
        &nbsp;&nbsp;
        <a href='$artUrl' target='_blank'>查看软件</a>
        &nbsp;&nbsp;
        <a href='content_list.php?channelid=$channelid'>管理软件</a>
        ";
    $wintitle = "成功更改软件！";
