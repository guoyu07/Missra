...
if(empty($dopost))
{
    ...
    include(MIMEMBER."/templets/archives_edit.htm");
    exit();
}
...
else if($dopost=='save')
{
    ...
    //返回成功信息
    $msg = "　　请选择你的后续操作：
        <a href='archives_add.php?cid=$typeid&channelid=$channelid'>发布新内容</a>
        &nbsp;&nbsp;
        <a href='archives_edit.php?channelid=$channelid&aid=".$aid."'>返回更改</a>
        &nbsp;&nbsp;
        <a href='$artUrl' target='_blank'>查看内容</a>
        &nbsp;&nbsp;
        <a href='content_list.php?channelid=$channelid'>管理内容</a>
        ";
    $wintitle = "成功更改内容！";
