...
if(empty($dopost))
{
    ...
    include(MIMEMBER."/templets/album_add.htm");
    exit();
}
...
else if($dopost=='save')
{
    ...
    include(MIMEMBER.'/inc/archives_check.php');
    $imgurls = "{missra:pagestyle maxwidth='$maxwidth' pagepicnum='$pagepicnum' ddmaxwidth='$ddmaxwidth' row='$prow' col='$pcol' value='$pagestyle'/}\r\n";
    $hasone = false;
    $ddisfirst=1;
