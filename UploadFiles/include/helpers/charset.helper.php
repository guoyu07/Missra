...
/**
 * Missra中用到的字符编码转换的小助手函数
 *
 * @version        $Id: charset.helper.php
 * @package        Mi.Helpers
...
if ( ! function_exists('utf82gb'))
{
    function utf82gb($utfstr)
    {
        ...
        if(empty($UC2GBTABLE))
        {
            $filename = MIINC."/data/gb2312-utf8.dat";
            $fp = fopen($filename,"r");
            while($l = fgets($fp,15))
            {
...
if ( ! function_exists('big52gb'))
{
    function big52gb($Text)
    {
        ...
        if(empty($BIG5_DATA))
        {
            $filename = MIINC."/data/big5-gb.dat";
...
if ( ! function_exists('gb2big5'))
{
    function gb2big5($Text)
    {
        ...
        if(empty($GB_DATA))
        {
            $filename = MIINC."/data/gb-big5.dat";
            $fp = fopen($filename, "rb");
...
if ( ! function_exists('UnicodeUrl2Gbk'))
{
    function UnicodeUrl2Gbk($str)
    {
        ...
        {
            $fp = fopen(MIINC.'/data/gbk-unicode.dat','rb');
            while(!feof($fp))
            {
