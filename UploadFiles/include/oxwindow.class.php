...
class OxWindow
{
    ...
    {
        $this->myWin .= "<script type='text/javascript'>\r\n";
     ...
     */
    function StartWin() {
        $this->myWin .= "<table width='100%' border='0' cellpadding='3' cellspacing='1' bgcolor='#E0E0E0' style='margin-bottom:10px'>\r\n";
    }
    ...
    function AddTitle($title, $col="2") {
        ...
        $this->myWinItem .= "<tr height='28' bgcolor='#F5F5F5'>\r\n";
        $this->myWinItem .= "<td $colspan background='{$cfg_plus_dir}/img/wbg.gif' height='26'>$title</td>\r\n";
        $this->myWinItem .= "</tr>\r\n";
    }
    ...
    function GetWindow($wintype="save", $msg="", $isform=true) {
        ...
        if($wintype!="") {
            if($wintype!="hand") {
                    ...
                    <td colspan='2' bgcolor='#F5F5F5'>
                        <table width='100%' border='0' cellpadding='0' cellspacing='0'>
                            <tr align='center' height='28'>
                                <td width='33%'></td>
                                <td width='33%'>
                                    <input name='imageField1' type='submit' class='np' value='确定' /> &nbsp;
                                    <input name='imageField1' type='submit' class='np' value='重置' onClick='this.form.reset();return false;' /> &nbsp;
                                    <input name='imageField1' type='submit' class='np' value='返回' onClick='history.go(-1);' />
                                </td>
                                <td width='33%'></td>
                            </tr>
                        </table>
                ...
                if($msg!='') {
                    $this->myWin .= "<tr><td bgcolor='#FFF' height='26'>$msg</td></tr>";
                } else {
                    $this->myWin .= '';
                }
            }
