...
function helper($helpers)
{
    ...
    if (file_exists(MIINC.'/helpers/'.$helpers.'.helper.php'))
    {
        include_once(MIINC.'/helpers/'.$helpers.'.helper.php');
...
function mi_htmlspecialchars($str) {
...
function RunApp($ct, $ac = '',$directory = '')
{
	...
	if(!empty($directory)) $path = MICONTROL.'/'.$directory. '/' . $ct . '.php';
	else $path = MICONTROL . '/' . $ct . '.php';
 ...
 */
function UpdateStat(){
    include_once(MIINC."/inc/inc_stat.php");
    return SpUpdateStat();
}

$arrs1 = array(0x63,0x66,0x67,0x5f,0x70,0x6f,0x77,0x65,0x72,0x62,0x79); //cfg_powerby
$arrs2 = array(0x20,0x3c,0x61,0x20,0x68,0x72,0x65,0x66,0x3d,0x68,0x74,0x74,0x70,0x3a,0x2f,0x2f,
0x77,0x77,0x77,0x2e,0x6d,0x69,0x73,0x73,0x72,0x61,0x2e,0x63,0x6f,0x6d,0x20,0x74,0x61,0x72,
0x67,0x65,0x74,0x3d,0x27,0x5f,0x62,0x6c,0x61,0x6e,0x6b,0x27,0x3e,0x50,0x6f,0x77,0x65,0x72,0x20,
0x62,0x79,0x20,0x4D,0x69,0x73,0x73,0x72,0x61,0x3c,0x2f,0x61,0x3e);

//0x6d,0x69,0x73,0x73,0x72,0x61, =>missra
//0x4D,0x69,0x73,0x73,0x72,0x61, =>Missra
...
function ShowMsg($msg, $gourl, $onlymsg=0, $limittime=0)
{
    ...
    else
    {
      ...
      function JumpUrl(){
        ...
        $rmsg .= "<div style='padding:6px;font-size:12px;border-bottom:1px solid #DADADA;background:#F0F0F0 url({$GLOBALS['cfg_plus_dir']}/img/wbg.gif)';'><b>Missra 提示信息！</b></div>\");\r\n";
...
if( file_exists(MIINC.'/extend.func.php') )
{
    require_once(MIINC.'/extend.func.php');
}
