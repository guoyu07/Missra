...
function lib_infoguide(&$ctag,&$refObj)
{
    ...
    if($hasSetEnumJs !='has' )
    {
        $revalue .= '<script type="text/javascript" src="'.$cfg_mainsite.$cmspath.'images/js/enums.js"></script>'."\r\n";
    ...
    $fields['nativeplace'] .= "<script type='text/javascript' src='{$cfg_mainsite}{$cmspath}data/enums/nativeplace.js'></script>\r\n";
    $fields['nativeplace'] .= '<script type="text/javascript">MakeTopSelect("nativeplace", '.$nativeplace.');</script>'."\r\n";
    ...
    $fields['infotype'] .= "<script type='text/javascript' src='{$cfg_mainsite}{$cmspath}data/enums/infotype.js'></script>\r\n";
    $fields['infotype'] .= '<script type="text/javascript">MakeTopSelect("infotype", '.$infotype.');</script>'."\r\n";
