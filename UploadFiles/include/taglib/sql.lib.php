...
<demo>
{missra:sql sql='' db='default'}
[field:title/]
{/missra}
</demo>
<attributes>
    <iterm>sql:需要查询的sql语句</iterm>
    <iterm>appname: 默认为default,即当前missra的数据库,如果需要自定义,可以在data/tag/sql.inc.php中扩展,具体扩展方法查看配置文件头部说明</iterm>
</attributes>
>>missra>>*/
...
function lib_sql(&$ctag,&$refObj)
{
    ...
    if ($appname != 'default')
    {
        require_once(MIDATA.'/tag/sql.inc.php');
        global $sqltag;
