 ...
 * 搜索视图类
 *
 * @version        $Id: arc.searchview.class.php
...
require_once(MIINC."/splitword.class.php");
require_once(MIINC."/taglib/hotwords.lib.php");
require_once(MIINC."/taglib/channel.lib.php");
...
class SearchView
{
    ...
    function GetPageListDM($list_len)
    {
        ...
        $infos = "<li><span>共<b>{$totalpage}</b>页/<b>".$this->TotalResult."</b>条记录</span></li>\r\n";
        ...
        {
            $indexpage="<li><a href='javascritp:void(0);'>首页</a></li>\r\n";
        }
        ...
        {
            $endpage="<li><a href='javascritp:void(0);'>末页</a></li>\r\n";
        }
        ...
        for($j; $j<=$total_list; $j++)
        {
            if($j == $this->PageNo)
            {
                $listdd.= "<li class='active'><a href='javascritp:void(0);'>$j</a></li>\r\n";
            }
            else
            {
        ...
        $plist .= $nextpage;
        $plist .= $endpage;
		$plist .= "<li class='hidenform'><form name='pagelist' action='".$this->GetCurUrl()."'>$hidenform";
