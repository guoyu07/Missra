      ...
      <form name="form1" action="catalog_edit.php" method="post">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="padding:0 20px;">
            ...
            <tr> 
                ...
                <td class='bline'>
                    <input type='radio' name='issend' value='0' class='np' <?php if($myrow['issend']=="0") echo " checked='1' ";?> />不支持&nbsp; 
                    <input type='radio' name='issend' value='1' class='np' <?php if($myrow['issend']=="1") echo " checked='1' ";?> />支持 
                </td>
            </tr>
            ...
            <tr>              
                <td align="center" colspan="2" height="50" bgcolor='#fff'>
                    <input name="imageField" type="submit" value="确定" class="np"/>&nbsp;&nbsp;&nbsp;
                    <input type="button" value="取消" onclick='CloseMsg()'/>
                </td>
            </tr>
        </table>
      </form>
...
{
    include MiInclude('templets/catalog_edit.htm');
}
?>