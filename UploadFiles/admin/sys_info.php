...
<?php
    ...
    {
        echo "<input type='text' name='edit___{$row['varname']}' id='edit___{$row['varname']}' value=\"".mi_htmlspecialchars($row['value'])."\" style='width:80%'>";
    }
    ?>
</td>
...
include MiInclude('templets/sys_info.htm');