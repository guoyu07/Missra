 ...
 * 搜索关键词管理
 *
 * @version        $Id: search_keywords_main.php
...
if($dopost=='')
{
    ...
    $totalRow = $row['dd'];
    include(MIADMIN."/templets/search_keywords_main.htm");
}
...
function GetKeywordList($dsql,$pageno,$pagesize,$orderby='aid')
{
    ...
    {
        $line = "
      <tr align='center' bgcolor='#FFFFFF' onMouseMove=\"javascript:this.bgColor='#FCFCFC';\" onMouseOut=\"javascript:this.bgColor='#FFFFFF';\">
