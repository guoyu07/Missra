 ...
 * 文件查看
 *
 * @version        $Id: file_manage_view.php
...
else if($fmdo=="editview")
{
    ...
    $GLOBALS['filename'] = $filename;
    $ctp = new MiTagParse();
    $ctp->LoadTemplate(MIADMIN."/templets/file_edit_view.htm");
    $ctp->display();
}
*/
//新建文件
...
{
    $ctp = new MiTagParse();
    $ctp->LoadTemplate(MIADMIN."/templets/file_upload.htm");
    $ctp->display();
}