 ...
 * 单表模型文档编辑
 *
 * @version        $Id: archives_sg_edit.php
...
if($dopost!='save')
{
    ...
    $tags = GetTags($aid);
    include MiInclude('templets/archives_sg_edit.htm');
    exit();
}
/*--------------------------------
function __save(){  }
...
else if($dopost=='save')
{
    ...
    $msg = "
    　　请选择你的后续操作：
    <a href='archives_sg_add.php?cid=$typeid'>发布新文档</a>
    &nbsp;&nbsp;
    <a href='archives_do.php?aid=".$id."&dopost=editArchives'>返回更改</a>
    &nbsp;&nbsp;
    <a href='$artUrl' target='_blank'>查看文档</a>
    &nbsp;&nbsp;
    <a href='catalog_do.php?cid=$typeid&channelid={$channelid}&dopost=listArchives'>管理文档</a>
    &nbsp;&nbsp;
