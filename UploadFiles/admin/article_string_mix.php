 ...
 * 防采集混淆字符串管理
 *
 * @version        $Id: article_string_mix.php
...
$m_file = MIDATA."/downmix.data.php";
...
$win->AddTitle("如果你要启用字符串混淆来防采集，请在文档模板需要的字段加上 function='RndString(@me)' 属性，如：{missra:field name='body' function='RndString(@me)'/}。");
