...
if($dopost=="ok")
{
    ...
    else if($step == 3)
    {
        ...
        if($uparc == 1)
        {
            echo "<script type='text/javascript'>location='sys_cache_up.php?dopost=ok&step=9';</script>";
        }
        else
        {
            echo "<script type='text/javascript'>location='sys_cache_up.php?dopost=ok&step=-1&uparc=$uparc';</script>";
        }
        exit();
    }
    //修正错误文档
...
include MiInclude('templets/sys_cache_up.htm');