...
require_once(MIADMIN.'/inc/inc_list_functions.php');
...
$optCache = MIDATA."/tplcache/inc_option_$optHash.inc";
...
$dlist->SetTemplate(MIADMIN.'/'.$s_tmplets);
