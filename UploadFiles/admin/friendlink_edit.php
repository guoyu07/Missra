 ...
 * 友情链接编辑
 *
 * @version        $Id: friendlink_edit.php
...
{
	require_once MIINC.'/request.class.php';
	$request = new Request();
	$request->Init();
	...
	if(!empty($logoimg))
	{
		$request->MoveUploadFile('logoimg', MIROOT.'/uploads/flink/'.$request->GetFileInfo('logoimg', 'name'));
...
include MiInclude('templets/friendlink_edit.htm');