...
$ImageWaterConfigFile = MIDATA."/mark/inc_photowatermark_config.php";
...
if($action=="save")
{
    ...
    if(is_uploaded_file($newimg))
    {
        ...
        @move_uploaded_file($newimg,MIDATA."/mark/".$photo_markimg);
    }
...
include MiInclude('templets/sys_info_mark.htm');