 ...
 * 模块菜单
 *
 * @version        $Id: inc_menu_module.php
...
<m:top name='文章模块管理' c='6,' display='block' rank=''>
<m:item name='文章栏目管理' link='ask_type.php' rank='' target='main' />
<m:item name='文章管理' link='ask_admin.php' rank='' target='main' />
<m:item name='文章管理' link='ask_answer.php' rank='' target='main' />
</m:top>
这个菜单可在生成模块时指定
*/
