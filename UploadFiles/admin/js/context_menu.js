/**
 * 
 * @version        $Id: context_menu.js
 * @package        Mi.Administrator
 * @copyright      Copyright (c)  2050, Missra, Inc.
...
ContextMenu.intializeContextMenu = function () {
    ...
    if (curNav() === 'IE') {
        WebFX_PopUp = document.frames['WebFX_PopUp'];
    } else {
...
ContextMenu.fixSize = function () {
    WebFX_PopUpcss.style.height = ItemHeight * ItemNember + 25 + "px";
