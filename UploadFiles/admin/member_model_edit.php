 ...
 * 会员模型编辑
 *
 * @version        $Id: member_model_edit.php
...
if($dopost=="save")
{
    ...
    $description = mi_htmlspecialchars($description);
...
else if($dopost=="copy")
{
    ...
    else if($job=="yes")
    {
        ...
        $newname = mi_htmlspecialchars($newname);
...
-----------------*/
$row = $dsql->GetOne("SELECT * FROM #@__member_model WHERE id='$id'");
include MIADMIN."/templets/member_model_edit.htm";