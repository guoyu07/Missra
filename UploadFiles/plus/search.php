...
require_once(MIINC."/arc.searchview.class.php");
...
if(empty($typeid))
{
    $typenameCacheFile = MIDATA.'/cache/typename.inc';
    if(!file_exists($typenameCacheFile) || filemtime($typenameCacheFile) < time()-(3600*24) )
    {
        $fp = fopen(MIDATA.'/cache/typename.inc', 'w');
        fwrite($fp, "<"."?php\r\n");
