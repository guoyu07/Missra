...
if(file_exists(MIROOT."/templets/default/$template"))
{
    $templatefile = MIROOT."/templets/default/$template";
}
else
{
    $templatefile = MIROOT."/templets/default/advancedsearch.htm";
}
