...
<embed src=\"play/flv.swf\" allowFullScreen=\"true\" FlashVars=\"vcastr_file={$url}&IsAutoPlay=1\" menu=\"false\" quality=\"high\" width=\"{$width}\" height=\"{$height}\" type=\"application/x-shockwave-flash\" pluginspage=\"http://www.macromedia.com/go/getflashplayer\" /></object>";
		...
		return $play;
		exit();
	}else if($players=='iqiyi'){
		$play = "<object classid=\"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000\" codebase=\"http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,124,0\" width=\"{$width}\" height=\"{$height}\" id=\"flashplayer\"><param name=\"movie\" value=\"http://www.iqiyi.com/player/{$url}/qiyi_player.swf\" /><param name=\"quality\" value=\"high\" /><param name=\"allowScriptAccess\" value=\"always\" /><param name=\"allowFullScreen\" value=\"true\" /><param name=\"flashvars\" value=\"vid={$url}\" /><embed src=\"http://www.iqiyi.com/player/{$url}/qiyi_player.swf\" quality=\"high\" pluginspage=\"http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash\" type=\"application/x-shockwave-flash\" width=\"{$width}\" height=\"{$height}\" allowScriptAccess=\"always\" allowFullScreen=\"true\" flashvars=\"vid={$url}\"></embed></object>";
		return $play;
		exit();
	}else if($players=='qq'){   
...
include_once(MITEMPLATE.'/plus/play.htm'); 
